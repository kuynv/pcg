    ...
    <div class="p-6">
        ...
        <table class="table-fixed w-full mt-4">
            ...
            <tr class="bg-gray-100">
                ...
                <th class="border px-4 py-2">Goods Id</th>
                <th class="border px-4 py-2">csgo_empire_item_id</th>
                <th class="border px-4 py-2">csgo_empire_price</th>
                <th class="border px-4 py-2">buff163_price	</th>
            ...
            @foreach($data as $index => $row)
                <tr>
                    ...
                    <td class="border px-4 py-2">{{$row->good_id}}</td>
                    <td class="border px-4 py-2">{{$row->csgo_empire_item_id}}</td>
                    <td class="border px-4 py-2">{{$row->csgo_empire_price}}</td>
                    <td class="border px-4 py-2">{{$row->buff163_price}}</td>

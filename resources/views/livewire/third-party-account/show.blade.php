    ...
    <div class="p-6">
        ...
        <table class="table-fixed w-full mt-4">
            ...
            <tr class="bg-gray-100">
                ...
                <th class="border px-4 py-2">Personal Access Token</th>
            ...
            @foreach($data as $index => $row)
                <tr>
                    ...
                    <td class="border px-4 py-2">{{$row->account_name}}</td>
                    <td class="border px-4 py-2">{{$row->personal_access_token}}</td>
    ...
    <x-jet-dialog-modal wire:model="itemModal">
        ...
        <x-slot name="content">
            ...
            <div class="col-span-12 mt-2">
                ...
                <x-jet-input id="account_name" type="text" class="mt-1 block w-full" wire:model.defer="item.account_name"/>
                <x-jet-input-error for="item.account_name" class="mt-2" />
            </div>
            <div class="col-span-12 mt-2">
                <x-jet-label for="personal_access_token" value="{{ __('Personal Access Token') }}" />
                <x-jet-input id="personal_access_token" type="text" class="mt-1 block w-full" wire:model.defer="item.personal_access_token"/>
                <x-jet-input-error for="item.personal_access_token" class="mt-2" />
            </div>
        </x-slot>
